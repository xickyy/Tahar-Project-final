  ...
  return (
    <div>
      ...
      <div className='tips-list-el'>
        <p className='font-bold mr-2 whitespace-nowrap border border-black custom-tips-title border-b-0'>Reliable and Durable Springs:</p>
      ...
      <div className='tips-list-el'>
        <p className='font-bold mr-2 whitespace-nowrap border border-black custom-tips-title border-b-0'>Balanced Door Operation:</p>
      ...
      <div className='tips-list-el'>
        <p className='font-bold mr-2 whitespace-nowrap border border-black custom-tips-title border-b-0'>Expert Spring Replacement and Repair:</p>
      ...
      <div className='tips-list-el'>
        <p className='font-bold mr-2 whitespace-nowrap border border-black custom-tips-title border-b-0'>Customized Spring Solutions:</p>
      ...
      <div className='tips-list-el'>
        <p className='font-bold mr-2 whitespace-nowrap border border-black custom-tips-title border-b-0'>Safety First Approach:</p>
      ...
      <div className='tips-list-el'>
        <p className='font-bold mr-2 whitespace-nowrap border border-black custom-tips-title border-b-0'>Preventive Maintenance:</p>
      ...
      <div className='tips-list-el'>
        <p className='font-bold mr-2 whitespace-nowrap border border-black custom-tips-title border-b-0'>Emergency Spring Services:</p>
