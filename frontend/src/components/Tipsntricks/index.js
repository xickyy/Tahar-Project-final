  ...
  return (
    <div>
      ...
      <div className='tips-list-el'>
        <p className='font-bold mr-2 whitespace-nowrap border border-black custom-tips-title border-b-0 md:mb-2 md:border-b'>Regular Inspection:</p>
      ...
      <div className='tips-list-el'>
        <p className='font-bold mr-2 whitespace-nowrap border border-black custom-tips-title border-b-0 md:mb-2 md:border-b'>Lubrication:</p>
      ...
      <div className='tips-list-el'>
        <p className='font-bold mr-2 whitespace-nowrap border border-black custom-tips-title border-b-0 md:mb-2 md:border-b'>Tighten Hardware:</p>
      ...
      <div className='tips-list-el'>
        <p className='font-bold mr-2 whitespace-nowrap border border-black custom-tips-title border-b-0 md:mb-2 md:border-b'>Balance Check:</p>
      ...
      <div className='tips-list-el'>
        <p className='font-bold mr-2 whitespace-nowrap border border-black custom-tips-title border-b-0 md:mb-2 md:border-b'>Weather Stripping:</p>
      ...
      <div className='tips-list-el'>
        <p className='font-bold mr-2 whitespace-nowrap border border-black custom-tips-title border-b-0 md:mb-2 md:border-b'>Test Safety Features:</p>
      ...
      <div className='tips-list-el'>
        <p className='font-bold mr-2 whitespace-nowrap border border-black custom-tips-title border-b-0 md:mb-2 md:border-b'>Spring Maintenance:</p>
      ...
      <div className='tips-list-el'>
        <p className='font-bold mr-2 whitespace-nowrap border border-black custom-tips-title border-b-0 md:mb-2 md:border-b'>Keep Remote Batteries Fresh:</p>
      ...
      <div className='tips-list-el'>
        <p className='font-bold mr-2 whitespace-nowrap border border-black custom-tips-title border-b-0 md:mb-2 md:border-b'>Professional Maintenance:</p>
