      ...
      <div className='container mx-auto flex flex-wrap'>
        ...
        <div className='w-full md:w-1/4 px-4'>
          ...
          <div className='flex justify-around md:flex-col md:text-center'>
            <Link className='text-blue-500 mt-2 custom-footer-link' to='/reviews'>Reviews</Link>
            <Link className='text-blue-500 mt-2 custom-footer-link' to='/services'>Services</Link>
            <Link className='text-blue-500 mt-2 custom-footer-link' to='/about'>About</Link>
            <Link className='text-blue-500 mt-2 custom-footer-link' to='/gallery'>Gallery</Link>
            <Link className='text-blue-500 mt-2 custom-footer-link' to='/faq'>FAQ</Link>
            <Link className='text-blue-500 mt-2 custom-footer-link' to='/contact'>Contact</Link>
          </div>
        </div>
